...
[pks2,locs2] = findpeaks(amplitude2(1:n2),t2(1:n2),'MinPeakDistance',0.7);
...
[M1,I1] = max(amplitude1);
[M2,I2] = max(amplitude2);
[M3,I3] = max(amplitude3);
...
hold on
plot(fun1([alpha1 beta1],locs1),'color','r','LineWidth', 1);
hold on
plot(fun2([alpha2 beta2],locs2),'color', [0, 0.4470, 0.7410],'LineWidth', 1);
hold on
plot(fun3([alpha3 beta3],locs3),'color','b' ,'LineWidth', 1);
grid on
