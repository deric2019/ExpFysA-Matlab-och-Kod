...
clear all
clc
[t1,x1,y1] = get_data_parameter(clear_zeros(str2double(table2array(importdata('PendelSondagKula2.mat')))));
[t2,x2,y2] = get_data_parameter(clear_zeros(str2double(table2array(importdata('PendelSondagKula3.mat')))));
...
[pks1,locs1] = findpeaks(amplitude1(1:n1),t1(1:n1),'MinPeakDistance',1.3); % Hittar peaks
[pks2,locs2] = findpeaks(amplitude2(1:n2),t2(1:n2),'MinPeakDistance',1.3);
[pks3,locs3] = findpeaks(amplitude3(1:n3),t3(1:n3),'MinPeakDistance',1.3);
...
beta3 = sol3(2);
hold on
plot(fun1([alpha1 beta1],linspace(0,140,135)),'r');
hold on
plot(fun2([alpha2 beta2],linspace(0,140,135)),'g');
hold on
plot(fun3([alpha3 beta3],linspace(0,120,120)),'b');


legend('m = 0.012kg' ,'m = 0.068kg' , 'm = 0.125kg ');
